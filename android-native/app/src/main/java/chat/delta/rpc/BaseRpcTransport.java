...
public abstract class BaseRpcTransport implements Rpc.RpcTransport {
  ...
  private JsonNode innerCall(String method, JsonNode... params) throws RpcException {
    ...
    try {
      ...
      throw new RpcException("Delta Chat RPC failed");
      ...
      throw new RpcException("Delta Chat RPC encoding failed");
    }
  }
  ...
  private void failPendingRequests() {
    for (SettableFuture<JsonNode> future : requestFutures.values()) {
      future.setException(new RpcException("Delta Chat RPC response failed"));
    }
