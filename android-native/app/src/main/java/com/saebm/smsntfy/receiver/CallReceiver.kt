package com.saebm.smsntfy.receiver
...
class CallReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val prefs = (context.applicationContext as com.saebm.smsntfy.SmsNtfyApplication).preferences
        ...
        if (listener == null) {
            listener = object : PhoneStateListener() {
                ...
                override fun onCallStateChanged(state: Int, phoneNumber: String) {
                    ...
                    val prefs = (contextRef?.applicationContext as? com.saebm.smsntfy.SmsNtfyApplication)?.preferences
                        ?: return
