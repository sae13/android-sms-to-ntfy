...
import com.saebm.smsntfy.update.ReleaseUpdateChecker
...
class MainActivity : AppCompatActivity() {
    ...
    private val requestPermissions = registerForActivityResult(
        ...
        val prefs = (application as com.saebm.smsntfy.SmsNtfyApplication).preferences
        if (initialPermissionRequestInFlight || !prefs.initialPermissionRequested) {
            (application as com.saebm.smsntfy.SmsNtfyApplication)
